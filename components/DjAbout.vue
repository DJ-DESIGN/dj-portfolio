<template>
  <b-container-fluid>
    <b-row class="about">
      <b-col md="1"></b-col>
      <b-col md="5" class="text-left pt-4">
        <floating-derek />
      </b-col>
    ...
    <b-row class="what-i-do pb-5">
      <b-col md="1"></b-col>
      <b-col md="5" class="p-3 pt-5 text-left">
...
<script>
import FloatingDerek from '~/components/FloatingDerek.vue'
import FloatingGlasses from '~/components/FloatingGlasses.vue'
