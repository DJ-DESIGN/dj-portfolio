<template>
  <div>
    ...
    <div class="p-5 bg-white mx-auto text-center">
      <b-row>
        <b-col>
          <h1 class="pb-3" data-aos="fade" data-aos-easing="ease">What I Deliver</h1>
        </b-col>
      </b-row>
      <b-row class="text-center pb-3" data-aos="fade-up" data-aos-easing="ease">
        <b-col md="4">
          <div class="p-2">
      ...
      <b-row>
        <b-col>
          <div class="pt-5 pb-2 text-center">
            <h3 data-aos="fade" data-aos-easing="ease">Featured Projects</h3>
          </div>
        </b-col>
      </b-row>
      <b-row class="pt-2 pb-5" data-aos="fade-up" data-aos-easing="ease">
        <b-col
